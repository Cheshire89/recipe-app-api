...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        """Test token is not created if invalid credential are give"""
        create_user(**self.payload)
        ...
        res = self.client.post(TOKEN_URL, testing_payload)
    ...
    def test_create_token_no_user(self):
        ...
        payload = {
            'email': 'test@otheremail.com',
            'passord': 'otherpassword'
        }
...
class PrivateUserApiTests(TestCase):
    ...
    def test_get_profile_ssuccess(self):
